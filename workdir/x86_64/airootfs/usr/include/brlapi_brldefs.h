...
#define BRL_CMD_PREFRESET (BRLAPI_KEY_TYPE_CMD | BRLAPI_KEY_CMD_PREFRESET)
/** set autospeak empty line on/off */
#define BRL_CMD_ASPK_EMP_LINE (BRLAPI_KEY_TYPE_CMD | BRLAPI_KEY_CMD_ASPK_EMP_LINE)
...
#define BRL_BLK_ROUTE_SPEECH (BRLAPI_KEY_TYPE_CMD | BRLAPI_KEY_CMD_ROUTE_SPEECH)
...
#define BRL_BLK_MACRO (BRLAPI_KEY_TYPE_CMD | BRLAPI_KEY_CMD_MACRO)
/** run host command */
#define BRL_BLK_HOSTCMD (BRLAPI_KEY_TYPE_CMD | BRLAPI_KEY_CMD_HOSTCMD)
/** enter key */
...
#define BRL_FLG_INPUT_CAPSLOCK BRLAPI_KEY_FLG_INPUT_CAPSLOCK
